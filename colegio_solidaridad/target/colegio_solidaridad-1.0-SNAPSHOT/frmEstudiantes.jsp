...
<html>
    ...
    <body>
        <div class="bd-example">
            <h1 position="center" >Insertar estudiante</h1>
            <form>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="inputRude">RUDE</label>
                        <input type="number" class="form-control" id="inputRude" placeholder="RUDE">
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="form-row ">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="inputTutor" class="form-control">
